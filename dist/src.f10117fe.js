...
var axios_1 = __importDefault(require("axios")); // ensures to TS that whatever data type we are sending in Id must be of type number
...
function () {
  function Eventing() {
    ...
    this.events = {}; // Setting the function below as bound function we put the equal sign
    // and the arrow function. This bounds referenced variable using this
    // to the variable on the left always

    this.on = function (eventName, callback) {
      var handlers = _this.events[eventName] || [];
      handlers.push(callback); //why do we have this function below
